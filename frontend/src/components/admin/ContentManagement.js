// components/admin/ContentManagement.js - Extracted from ContentManagementPage
    ...
    <div>
      ...
      <div className="row">
        ...
        <div className="col-md-3">
          <div className="card shadow-sm" style={{ backgroundColor: cardBg, color: textColor }}>
            ...
            <div className="list-group list-group-flush">
              {contents.map(content => (
                <button
                  ...
                  style={{
                    backgroundColor: selectedContent?.id === content.id 
                      ? '#0d6efd' 
                      : (theme === 'dark' ? '#2d2d2d' : '#ffffff'),
                    color: selectedContent?.id === content.id 
                      ? '#ffffff' 
                      : textColor,
                ...
                {!editMode && !previewMode ? (
                  <div>
                    ...
                    <div className="mb-3">
                      ...
                      >
                        <pre className="mb-0" style={{whiteSpace: 'pre-wrap', fontFamily: 'inherit', color: textColor}}>
